...
package com.pmc.task.manager.service.persistence;
...
/**
 * The persistence utility for the task service. This utility wraps <code>com.pmc.task.manager.service.persistence.impl.TaskPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TaskUtil {
	...
	public static Task findByUuid_First(
		...
		throws com.pmc.task.manager.exception.NoSuchTaskException {
	 ...
	 * @return the matching tasks
	 */
	public static List<Task> findByAccomplished(boolean accomplished) {
		return getPersistence().findByAccomplished(accomplished);
	}
	 ...
	 * @return the range of matching tasks
	 */
	public static List<Task> findByAccomplished(
		boolean accomplished, int start, int end) {

		return getPersistence().findByAccomplished(accomplished, start, end);
	}
	...
	public static List<Task> findByAccomplished(
		...
		return getPersistence().findByAccomplished(
			accomplished, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchTaskException if a matching task could not be found
	 */
	public static Task findByAccomplished_First(
			boolean accomplished, OrderByComparator<Task> orderByComparator)
		throws com.pmc.task.manager.exception.NoSuchTaskException {

		return getPersistence().findByAccomplished_First(
			accomplished, orderByComparator);
	}
	 ...
	 * @return the first matching task, or <code>null</code> if a matching task could not be found
	 */
	public static Task fetchByAccomplished_First(
		boolean accomplished, OrderByComparator<Task> orderByComparator) {

		return getPersistence().fetchByAccomplished_First(
			accomplished, orderByComparator);
	}
	 ...
	 * @throws NoSuchTaskException if a matching task could not be found
	 */
	public static Task findByAccomplished_Last(
			boolean accomplished, OrderByComparator<Task> orderByComparator)
		throws com.pmc.task.manager.exception.NoSuchTaskException {

		return getPersistence().findByAccomplished_Last(
			accomplished, orderByComparator);
	}
	 ...
	 * @return the last matching task, or <code>null</code> if a matching task could not be found
	 */
	public static Task fetchByAccomplished_Last(
		boolean accomplished, OrderByComparator<Task> orderByComparator) {

		return getPersistence().fetchByAccomplished_Last(
			accomplished, orderByComparator);
	}
	 ...
	 * @throws NoSuchTaskException if a task with the primary key could not be found
	 */
	public static Task[] findByAccomplished_PrevAndNext(
			long taskId, boolean accomplished,
			OrderByComparator<Task> orderByComparator)
		throws com.pmc.task.manager.exception.NoSuchTaskException {

		return getPersistence().findByAccomplished_PrevAndNext(
			taskId, accomplished, orderByComparator);
	}
	 ...
	 * @param accomplished the accomplished
	 */
	public static void removeByAccomplished(boolean accomplished) {
		getPersistence().removeByAccomplished(accomplished);
	}
	 ...
	 * @return the number of matching tasks
	 */
	public static int countByAccomplished(boolean accomplished) {
		return getPersistence().countByAccomplished(accomplished);
	}
