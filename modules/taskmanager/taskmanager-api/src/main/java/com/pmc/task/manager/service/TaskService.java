...
public interface TaskService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TaskServiceUtil} to access the task remote service. Add custom service methods to <code>com.pmc.task.manager.service.impl.TaskServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public Task addTask(
