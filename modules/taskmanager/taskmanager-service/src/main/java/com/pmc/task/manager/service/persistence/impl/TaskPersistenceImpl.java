...
package com.pmc.task.manager.service.persistence.impl;
...
import com.pmc.task.manager.exception.NoSuchTaskException;
import com.pmc.task.manager.model.Task;
import com.pmc.task.manager.model.impl.TaskImpl;
import com.pmc.task.manager.model.impl.TaskModelImpl;
import com.pmc.task.manager.service.persistence.TaskPersistence;
import com.pmc.task.manager.service.persistence.impl.constants.TMPersistenceConstants;
...
public class TaskPersistenceImpl
	...
	public List<Task> findByUuid(
		...
		List<Task> list = (List<Task>)finderCache.getResult(
	...
	private FinderPath _finderPathWithPaginationFindByAccomplished;
	private FinderPath _finderPathWithoutPaginationFindByAccomplished;
	private FinderPath _finderPathCountByAccomplished;
	...
	public List<Task> findByAccomplished(boolean accomplished) {
		return findByAccomplished(
			accomplished, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Task> findByAccomplished(
		boolean accomplished, int start, int end) {
	 ...
	 * </p>
	 *
	 * @deprecated As of Mueller (7.2.x), replaced by {@link #findByAccomplished(boolean, int, int, OrderByComparator)}
	 * @param accomplished the accomplished
	 * @param start the lower bound of the range of tasks
	 * @param end the upper bound of the range of tasks (not inclusive)
	 * @param orderByComparator the comparator to order the results by (optionally <code>null</code>)
	...
	public List<Task> findByAccomplished(
		...
		return findByAccomplished(accomplished, start, end, orderByComparator);
	}
	...
	public List<Task> findByAccomplished(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderPath = _finderPathWithoutPaginationFindByAccomplished;
			finderArgs = new Object[] {accomplished};
		}
		else {
			finderPath = _finderPathWithPaginationFindByAccomplished;
			finderArgs = new Object[] {
				accomplished, start, end, orderByComparator
			};
		}
		...
		if ((list != null) && !list.isEmpty()) {
			for (Task task : list) {
				if ((accomplished != task.isAccomplished())) {
					list = null;
	 ...
	 */
	@Override
	public Task findByAccomplished_First(
			boolean accomplished, OrderByComparator<Task> orderByComparator)
		throws NoSuchTaskException {
	 ...
	 */
	@Override
	public Task fetchByAccomplished_First(
		boolean accomplished, OrderByComparator<Task> orderByComparator) {

		List<Task> list = findByAccomplished(
			accomplished, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Task findByAccomplished_Last(
			boolean accomplished, OrderByComparator<Task> orderByComparator)
		throws NoSuchTaskException {
	 ...
	 */
	@Override
	public Task fetchByAccomplished_Last(
		boolean accomplished, OrderByComparator<Task> orderByComparator) {
		...
		List<Task> list = findByAccomplished(
			accomplished, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public Task[] findByAccomplished_PrevAndNext(
			long taskId, boolean accomplished,
			OrderByComparator<Task> orderByComparator)
		throws NoSuchTaskException {
		...
		try {
			...
			array[0] = getByAccomplished_PrevAndNext(
				session, task, accomplished, orderByComparator, true);

			array[1] = task;

			array[2] = getByAccomplished_PrevAndNext(
				session, task, accomplished, orderByComparator, false);
	...
	protected Task getByAccomplished_PrevAndNext(
		Session session, Task task, boolean accomplished,
		OrderByComparator<Task> orderByComparator, boolean previous) {
	...
	public int countByAccomplished(boolean accomplished) {
		FinderPath finderPath = _finderPathCountByAccomplished;
	...
	private static final String _FINDER_COLUMN_ACCOMPLISHED_ACCOMPLISHED_2 =
		"task.accomplished = ?";
	...
	public Task updateImpl(Task task) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {taskModelImpl.isAccomplished()};

			finderCache.removeResult(_finderPathCountByAccomplished, args);
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByAccomplished, args);
			...
			if ((taskModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByAccomplished.
					 getColumnBitmask()) != 0) {

				Object[] args = new Object[] {
					taskModelImpl.getOriginalAccomplished()
				};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			TaskModelImpl.PRIORITY_COLUMN_BITMASK);
		...
		_finderPathWithPaginationFindByAccomplished = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, TaskImpl.class,
		...
		_finderPathWithoutPaginationFindByAccomplished = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, TaskImpl.class,
		...
		_finderPathCountByAccomplished = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, Long.class,
	...
	@Override
	@Reference(
		target = TMPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.pmc.task.manager.model.Task"),
			true);
	}
	...
	static {
		try {
			Class.forName(TMPersistenceConstants.class.getName());
		}
